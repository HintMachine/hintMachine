...
namespace HintMachine.Games
{
    public class SuperMonkeyBall2Connector : IDolphinConnector
    {
        ...
        public SuperMonkeyBall2Connector() : base(false, "GM2E8P")
        {
        ...
        {     
            ...
            int player1banana = _ram.ReadUint8(_mem1Addr + 0x5bca1b); 
	    ...
	    int world2 = _ram.ReadUint8(_mem1Addr + 0x5d4b43);
            ...
            int world6 = _ram.ReadUint8(_mem1Addr + 0x5d4c23);
            int world7 = _ram.ReadUint8(_mem1Addr + 0x5d4c5b);
            int world8 = _ram.ReadUint8(_mem1Addr + 0x5d4c93);
            int world9 = _ram.ReadUint8(_mem1Addr + 0x5d4ccb);
            int world10 = _ram.ReadUint8(_mem1Addr + 0x5d4d03);

            // Challenge mode clears
            int player1challenge = _ram.ReadUint8(_mem1Addr + 0x5d4973);

            // Checks if story menu is accessed which sets progress to 0
            int inStoryMenu = _ram.ReadUint8(_mem1Addr + 0x54dbef);
