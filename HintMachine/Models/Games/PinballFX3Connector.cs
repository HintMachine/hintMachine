...
namespace HintMachine.Models.Games
{
    ...
    public class PinballFX3Connector : IGameConnector
    {
        ...
        private Dictionary<long, TableData> _tableDataMapping = new Dictionary<long, TableData>
        {
            ...
            { 133, new TableData("Indiana Jones", 54000000) },
            ...
            { 105, new TableData("Star Wars: Solo", 13500000)},
            { 106, new TableData("Star Wars: Calrissian Chronicles", 6750000)},
            { 107, new TableData("Star Wars: Battle of Mimban", 9000000)},
            { 103, new TableData("Star Wars: The Last Jedi", 22500000)},
            { 104, new TableData("Star Wars: Ahch-To Island", 13500000)},
            { 98, new TableData("Star Wars: Rogue One", 5400000)},
            { 77, new TableData("Star Wars: Star Wars Rebels", 7650000)},
            { 88, new TableData("Star Wars: The Force Awakens", 9000000)},
            { 89, new TableData("Star Wars: Might of the First Order", 3600000)},
            { 10, new TableData("Star Wars: Han Solo", 2250000)},
            { 58, new TableData("Star Wars: Droids", 2250000)},
            { 12, new TableData("Star Wars: E4 A New Hope", 8100000)},
            { 2, new TableData("Star Wars: Masters of the Force", 2250000)},
            { 24, new TableData("Star Wars: E6 Return of the Jedi", 4050000)},
            { 28, new TableData("Star Wars: Darth Vader", 9000000)},
            { 6, new TableData("Star Wars: Starfighter Assault", 3600000)},
            { 43, new TableData("Star Wars: E5 The Empire Strikes Back", 8100000)},
            { 47, new TableData("Star Wars: The Clone Wars", 6300000)},
            { 53, new TableData("Star Wars: Boba Fett", 4500000)},
